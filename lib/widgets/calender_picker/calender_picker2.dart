...
// /// [day] - day being built.
// typedef Widget? DayBuilder(bool isSelectable, int index, bool isSelectedDay, bool isToday, bool isPrevMonthDay,
...
//             shape:
//                 widget.markedDateCustomShapeBorder != null && markedDatesMap != null && markedDatesMap.getEvents(now).length > 0
...
//                     bool isSelectedDay = this._selectedDate.year == weekDays[index].year &&
...
//     for (int _cnt = 0; 0 >= minDate.add(Duration(days: 7 * _cnt)).difference(maxDate.add(Duration(days: 7))).inDays; _cnt++) {
...
//                   child: Center(
//                     child: Text(
//                       markedDateMoreShowTotal ? (count + markedDateIconMaxShown).toString() : (count.toString() + '+'),
//                       semanticsLabel:
//                           markedDateMoreShowTotal ? (count + markedDateIconMaxShown).toString() : (count.toString() + '+'),
