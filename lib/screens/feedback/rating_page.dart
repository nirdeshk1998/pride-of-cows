...
import 'package:poc/screens/feedback/providers/rating_provider.dart';
...
class RatingPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final read = ref.read(ratingProvider);
    final watch = ref.watch(ratingProvider);
                ...
                children: [
                  ...
                  RichText(text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                            text: " was completed succesfully",
                            style: TextStyle(
                                fontSize: 14,
                                color: Palette.textColor
                            )
