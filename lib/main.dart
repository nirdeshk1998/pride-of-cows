...
import 'package:poc/network/services/firebase/firebase_messaging.dart';
...
Future<void> main() async {
  ...
  FirebaseMessaging.onMessage.listen(FCMService.fcmForgroundHandler);

  await LocalStorage.setString(await FirebaseMessaging.instance.getToken(), StorageField.fcmToken);
